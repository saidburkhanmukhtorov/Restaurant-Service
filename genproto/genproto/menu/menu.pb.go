...
var file_submodule_reservation_menu_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x10, 0x5a, 0x0e, 0x2f, 0x67, 0x65, 0x6e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6d,
...
var file_submodule_reservation_menu_proto_goTypes = []interface{}{
...
func file_submodule_reservation_menu_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_submodule_reservation_menu_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Menu); i {
			case 0:
				return &v.state
			case 1:
		...
		file_submodule_reservation_menu_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_submodule_reservation_menu_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
